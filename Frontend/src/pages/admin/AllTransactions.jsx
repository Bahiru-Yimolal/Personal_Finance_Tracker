...
import { useGetAllTransactionsAdminQuery, useGetCategoriesQuery } from '../../features/transactions/redux/transactionApiSlice';
...
const AllTransactions = () => {
    ...
    const { data: response, isLoading, error } = useGetAllTransactionsAdminQuery(filters);
                                    ...
                                    >
                                        ...
                                        <TableCell>
                                            <Stack direction="row" spacing={1} alignItems="center">
                                                ...
                                                <Box>
                                                    <Typography variant="body2" fontWeight="600">{row.user?.username}</Typography>
                                ...
                                {(!transactions || transactions.length === 0) && (
                                    <TableRow>
                                        <TableCell colSpan={6} align="center" sx={{ py: 8, color: 'text.secondary' }}>
                                            <Typography variant="body1">{t('noTransactions')}</Typography>
                                        </TableCell>
                                    </TableRow>
                                )}
                            </TableBody>
                        ...
                        <Box>
                            ...
                            <Grid container spacing={0}>
                                <Grid item xs={12} sm={6}>
                                    <DetailItem icon={<PersonIcon />} label={t('user')} value={modalState.transaction.user?.username || 'N/A'} />
